...
bool Add(behavior_tree_ros::AddTwoInts::Request  &req,
         behavior_tree_ros::AddTwoInts::Response &res)
{
  res.sum = req.a + req.b;
...
protected:
  ...
  actionlib::SimpleActionServer<behavior_tree_ros::FibonacciAction> server_;
  std::string action_name_;
  // create messages that are used to published feedback/result
  behavior_tree_ros::FibonacciFeedback feedback_;
  behavior_tree_ros::FibonacciResult result_;
...
public:
  ...
  void executeCB(const behavior_tree_ros::FibonacciGoalConstPtr &goal)
  {
