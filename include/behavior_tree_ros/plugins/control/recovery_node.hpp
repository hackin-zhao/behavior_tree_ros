...
#ifndef _BEHAVIOR_TREE__PLUGINS__CONTROL__RECOVERY_NODE_HPP_
#define _BEHAVIOR_TREE__PLUGINS__CONTROL__RECOVERY_NODE_HPP_
...
public:
  /**
   * @brief A constructor for behavior_tree::RecoveryNode
  ...
  /**
   * @brief A destructor for behavior_tree::RecoveryNode
   */
...
#endif  // _BEHAVIOR_TREE__PLUGINS__CONTROL__RECOVERY_NODE_HPP_
