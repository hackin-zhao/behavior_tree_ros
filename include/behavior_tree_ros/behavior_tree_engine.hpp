...
#ifndef _BEHAVIOR_TREE__BEHAVIOR_TREE_ENGINE_HPP_
#define _BEHAVIOR_TREE__BEHAVIOR_TREE_ENGINE_HPP_
 ...
 */
  ...
  /**
 * @class behavior_tree::BehaviorTreeEngine
 ...
 */
   ...
   * @return behavior_tree::BtStatus Status of BT execution
   */
    BtStatus run(
        BT::Tree *tree,
        std::function<void()> onLoop,
        std::function<bool()> cancelRequested,
        ros::Duration loopTimeout = ros::Duration(0.01));
...
#endif // _BEHAVIOR_TREE__BEHAVIOR_TREE_ENGINE_HPP_
